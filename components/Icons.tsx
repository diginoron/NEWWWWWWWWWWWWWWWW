...
export const LightBulbIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 18h6" />
        <path d="M10 22h4" />
        <path d="M12 14.2c-2.3 0-4.2-1.9-4.2-4.2S9.7 5.8 12 5.8s4.2 1.9 4.2 4.2c0 1.2-0.5 2.3-1.3 3.1" />
        <path d="M12 2a4.2 4.2 0 0 0-4.2 4.2v2.2c0 2.3 1.9 4.2 4.2 4.2s4.2-1.9 4.2-4.2V6.2A4.2 4.2 0 0 0 12 2Z" />
    </svg>
);
