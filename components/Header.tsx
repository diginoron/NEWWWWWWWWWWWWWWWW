  ...
  return (
    <header className="text-center mb-8 sm:mb-12">
      ...
      <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed">
        <strong className="text-amber-400">توجه </strong>
        <strong className="text-red-500">توجه </strong>
        <strong className="text-amber-400">توجه: </strong>
        هوش مصنوعی فقط برای کمک به شما برای ایده پردازی در انجام پایان نامه است. استفاده تنها از آن ممکن است منجر به از بین رفتن سابقه تحصیلی شما توسط وزارت علوم شود. برای دریافت خدمات مشاوره تخصصی به گروه تخصصی کاسپین تز مراجعه کنید.
      </p>
      <div className="mt-6">
        <a
