...
import { generateThesisSuggestions, findRelevantArticles, translateText, generatePreProposal, summarizeArticle, evaluateProposal, translateGeneralText, sendChatMessage } from './services/geminiService';
...
const App: React.FC = () => {
  ...
  const handleSummarize = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await summarizeArticle(text.substring(0, 15000));
      setSummary(result);
    } catch (err) {
